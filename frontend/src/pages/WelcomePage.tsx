...
// header/hero buttons wired to auth routes; "Sign in" buttons still inert
// until the rest of the nav flow is decided
      ...
      <main className="flex flex-col items-center text-center px-6 pt-20 pb-14">
        ...
        <div className="flex items-center gap-3 mb-16">
          ...
          <button
            onClick={() => navigate("/sign-in")}
            className="text-sm font-medium px-6 py-3 rounded-lg"
            style={{ color: NAVY, background: "transparent", border: `1.5px solid ${NAVY}`, cursor: "pointer" }}
          >
            Sign in
          </button>
        </div>
        ...
        >
          <p className="text-xs font-medium tracking-widest uppercase mb-4" style={{ color: TEXT_MUTED }}>
            Live preview — sample dataset
          </p>
          <PreviewChart />
        </div>
      </main>
